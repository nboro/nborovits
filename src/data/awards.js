...
export const skills = {
  ...
  service: [
    ...
    'Reviewer for artificial intelligence, privacy and software engineering venues',
    'CIPP/E certification (in progress)',
  ],
  languages: [
    { name: 'Greek', level: 'Native' },
    { name: 'Serbian', level: 'Native' },
    { name: 'English', level: 'Proficient (C2 - CPE University of Michigan, IELTS)' },
    { name: 'Dutch', level: 'A2, Working knowledge' },
  ],
};
